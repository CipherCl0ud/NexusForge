...
export default function ToolCard({ title, description, icon: Icon, accentColor, onClick }) {
  return (
    <motion.button
      onClick={onClick}
      ...
      className="glass-panel p-6 cursor-pointer group relative overflow-hidden flex flex-col h-full border border-white/5 hover:border-white/20 transition-colors text-left w-full"
    >
